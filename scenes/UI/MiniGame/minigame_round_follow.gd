extends Control
class_name MiniGameRoundFollow
...
@onready var catchable_follow_scene := preload("res://scenes/UI/MiniGame/MinigameFollowCatchable.tscn")
...
func _spawn_catchable() -> void:
	var obj = catchable_follow_scene.instantiate()
	center.add_child(obj)
	obj.init(minigame_res)
